...
const AUTH_BUTTON_STYLES = Object.freeze({
  ...
  idle: "bg-gray-700 text-gray-100 hover:bg-gray-600",
...
export const LoginButton = () => {
  ...
  const buttonStyles = `${AUTH_BUTTON_STYLES.base} ${
    isLoading ? AUTH_BUTTON_STYLES.loading : AUTH_BUTTON_STYLES.idle
  }`;
  ...
  return (
    ...
    >
      <GitHubIcon />
      <span data-testid="login-button-text">
        {isLoading ? _({ id: "auth.authenticating" }) : _({ id: "auth.login" })}
      </span>
    </button>
  );
};
